    ...
    >
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
        ...
        <motion.a
          ...
          className="p-4 bg-[#0077b5] text-white rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 flex items-center justify-center glow-effect"
        ...
        <motion.a
          href="https://wa.me/2349056453575"
          target="_blank"
          rel="noopener noreferrer"
          className="p-4 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 flex items-center justify-center glow-effect"
          initial={{ opacity: 0, scale: 0 }}
          animate={{ opacity: 1, scale: 1 }}
