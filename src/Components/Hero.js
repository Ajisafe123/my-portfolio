    ...
    >
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-1">
        ...
        <motion.a
          ...
          className="p-4 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 flex items-center justify-center glow-effect relative z-10"
